...
n_models = 3  
model = MolecularModel(n_models=n_models, X_pool = X_pool, y_pool = y_pool, iter_per_group=3)
...
model.train(num_iters=9, query_fn=most_unc_query, batch_size=3, use_uncertainty = False)
